...
np.savetxt('SFMGeneIDs_T2vT3_3.csv', GeneIDs, delimiter=",", fmt='%s');
np.savetxt('SFMFeats_T2vT3_3.csv', X_transform, delimiter=",");
#exit();
#'''
...
f=open("Scores_linear_T2vT3_gar.txt", "w+");
...
for n in Ns: 
	...
	np.savetxt('Linear_T2vT3.csv', GeneIDsRFE, delimiter=",", fmt='%s');
	...
	Y_pred = cross_val_predict(SVM, XRFE, ZY, cv = 3)	
