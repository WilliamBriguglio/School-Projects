...
f=open("Scores_rbf_T2vT3_M.txt", "w+"); #open file for saving scores and confusion matrices
...
for n in Ns: 
	...
	#np.savetxt('rbf_T2vT3.csv', GeneIDsRFE, delimiter=",", fmt='%s'); #save feature ID's
	print(Xmrmr.shape)
	...
	Y_pred = cross_val_predict(SVM, Xmrmr, ZY, cv = 3)#obtain prediction results with best params
